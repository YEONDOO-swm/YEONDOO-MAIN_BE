...
@Import({BatisAuthorRepository.class, BatisPaperBufferRepository.class, BatisPaperInfoRepository.class, BatisQueryHistoryRepository.class, PaperService.class, BatisPaperRepository.class, BatisLikePaperRepository.class, BatisUserRepository.class, BatisStudyFieldRepository.class, BatisLikePaperRepository.class})
public class HttpPaperTest {
    ...
    public void test2dot2Success() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.paperinfo.cites").value(81860))
