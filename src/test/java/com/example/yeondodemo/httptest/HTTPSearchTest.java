...
import com.example.yeondodemo.repository.studyfield.MemoryStudyFieldRepository;
...
@Import({BatisAuthorRepository.class, BatisPaperBufferRepository.class, BatisPaperInfoRepository.class, BatisQueryHistoryRepository.class, SearchService.class, BatisPaperRepository.class, BatisLikePaperRepository.class, BatisUserRepository.class, BatisStudyFieldRepository.class, BatisLikePaperRepository.class})
public class HTTPSearchTest {
    ...
    public void searchSuccess() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.papers[0].likes").value(200))
                .andExpect(jsonPath("$.papers[0].islike").value(true))
                .andExpect(jsonPath("$.papers[0].title").value("Some Insights into Lifelong Reinforcement Learning Systems"))
                .andExpect(jsonPath("$.papers[0].cites").value(81192))
                .andExpect(jsonPath("$.papers[1].likes").value(12))
                ...
                .andExpect(jsonPath("$.papers[1].cites").value(170));
    }
    @Test
