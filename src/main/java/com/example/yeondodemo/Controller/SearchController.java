...
public class SearchController {
    ...
    public ResponseEntity search(@RequestHeader("X-Auth-Token") String jwt,@RequestParam String query, @RequestParam String username, @RequestParam Integer searchType){
    ...
    public ResponseEntity resultScore(@RequestHeader("X-Auth-Token") String jwt,@RequestParam String username, @Validated @RequestBody PaperResultRequest paperResultRequest, BindingResult bindingResult){
    ...
    public ResponseEntity likeOnOff(@RequestHeader("X-Auth-Token") String jwt,@Validated @RequestBody LikeOnOffDTO likeOnOffDTO, BindingResult bindingResult){
    ...
    public ResponseEntity paperContainer(@RequestHeader("X-Auth-Token") String jwt,@RequestParam String username){
        if(UserValidator.isNotValidName(username)){return new ResponseEntity<>(HttpStatus.UNAUTHORIZED);}
