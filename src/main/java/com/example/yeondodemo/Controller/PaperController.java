...
public class PaperController {
    ...
    @GetMapping("/{paperid}")
    public ResponseEntity paperInfo(@RequestHeader("X-Auth-Token") String jwt,@PathVariable String paperid, @RequestParam String username){
    ...
    @PostMapping("/{paperid}")
    public ResponseEntity paperQuestion(@RequestHeader("X-Auth-Token") String jwt,@PathVariable String paperid, @RequestParam String username, @Validated @RequestBody QuestionDTO question, BindingResult bindingResult){
