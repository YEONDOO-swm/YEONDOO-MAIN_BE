...
# Database: MAIN
# Generation Time: 2023-08-07 16:07:15 +0000
# ************************************************************
...
CREATE TABLE `AUTHOR` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_PAPER_TO_AUTHOR_1` (`paperId`),
  CONSTRAINT `FK_PAPER_TO_AUTHOR_1` FOREIGN KEY (`paperId`) REFERENCES `PAPER` (`paperId`)
...
CREATE TABLE `PAPER` (
  ...
  `journalRef` varchar(300) DEFAULT NULL,
  `doi` varchar(100) DEFAULT NULL,
  `categories` varchar(125) DEFAULT NULL,
